...
namespace FlappyBird
{
    public partial class Form1 : Form
    {
        ...
        private void tmrGame_Tick(object sender, EventArgs e)
        {
            ...
            pbPipe3.Left -= hiz;
            pbPipe4.Left -= hiz;
            if (pbPipe1.Right < 0) // Kuş ilerledikten sonra borular Ekrandan çıktığı için tekrardan ekrana sokuyor
            {
            ...
            {
                score++;
                pbPipe1Control = true;   //Score artırmak için eğer bunu kontrol etmezsem her 20milisaniyede skor artar.
            }
